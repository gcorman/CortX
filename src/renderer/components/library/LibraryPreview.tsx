    ...
    return (
      <div className="flex-1 flex items-center justify-center text-cortx-text-secondary">
        <div className="text-center">
          ...
          <p className="text-xs">Sélectionnez un document</p>
        </div>
      </div>
    )
  }
    ...
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="flex-shrink-0 px-4 py-3 border-b border-cortx-border flex items-center gap-3">
        ...
        <button
          ...
          title="Ouvrir avec le logiciel système"
        >
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
        {!preview ? (
          <p className="text-xs text-cortx-text-secondary italic animate-pulse">Chargement…</p>
        ) : (
